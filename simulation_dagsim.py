...
def setup_realworld(pipeline_type, training_n, test_n):
    if(pipeline_type==1):
        ...
        Prior2 = Node(name="B", function=np.random.binomial, kwargs={"n": 1, "p": 0.5})
        Prior3 = Node(name="C", function=np.random.binomial, kwargs={"n": 1, "p": 0.5})
        Prior4 = Node(name="D", function=np.random.binomial, kwargs={"n": 1, "p": 0.5})
        Node1 = Node(name="E", function=log_transformation,
        ...
        Prior3 = Node(name="C", function=np.random.binomial, kwargs={"n": 1, "p": 0.5})
        Prior4 = Node(name="D", function=np.random.binomial, kwargs={"n": 1, "p": 0.5})
        Node1 = Node(name="E", function=log_transformation_nonlinear,
                        kwargs={"params0": Prior1, "params1": Prior2, "params2": Prior3, "params3": Prior4})
        ...
        Prior1 = Node(name="A", function=np.random.binomial, kwargs={"n": 1, "p": 0.5})
        Prior2 = Node(name="B", function=from_A_get_B, kwargs={"A": Prior1})
        Prior3 = Node(name="C", function=from_A_get_B, kwargs={"A": Prior1})
        Prior4 = Node(name="D", function=np.random.binomial, kwargs={"n": 1, "p": 0.5})
        Node1 = Node(name="E", function=log_transformation,
                        kwargs={"params0": Prior1, "params1": Prior2, "params2": Prior3, "params3": Prior4})
        listNodes = [Prior1, Prior2, Prior3, Prior4, Node1]
        ...
        Prior3 = Node(name="C", function=np.random.binomial, kwargs={"n": 1, "p": 0.5})
        Prior4 = Node(name="D", function=np.random.binomial, kwargs={"n": 1, "p": 0.5})
        Prior5 = Node(name="E", function=np.random.binomial, kwargs={"n": 1, "p": 0.5})
        Prior6 = Node(name="F", function=np.random.binomial, kwargs={"n": 1, "p": 0.5})
        Prior7 = Node(name="G", function=np.random.binomial, kwargs={"n": 1, "p": 0.5})
        Prior8 = Node(name="H", function=np.random.binomial, kwargs={"n": 1, "p": 0.5})
        Prior9 = Node(name="I", function=np.random.binomial, kwargs={"n": 1, "p": 0.5})
        Prior10 = Node(name="J", function=np.random.binomial, kwargs={"n": 1, "p": 0.5})
        Node1 = Node(name="K", function=log_transformation_dimensionality,
                        kwargs={"params0": Prior1, "params1": Prior2, "params2": Prior3, "params3": Prior4, "params4": Prior5, "params5": Prior6, "params6": Prior7, "params7": Prior8, "params8": Prior9, "params9": Prior10})
