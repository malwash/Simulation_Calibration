...
def decision_tree(x_train, y_train, x_test, y_test):
    ...
    return cross_val_score(clf, x_train, y_train, cv=10)
...
def random_forest(x_train, y_train, x_test, y_test):
    ...
    #return metrics.accuracy_score(y_test,y_pred)
    return cross_val_score(rf, x_train, y_train, cv=10)
...
def logistic_regression(x_train, y_train, x_test, y_test):
    ...
    return cross_val_score(lr, x_train, y_train, cv=10)
...
def naive_bayes(x_train, y_train, x_test, y_test):
    ...
    return cross_val_score(gnb, x_train, y_train, cv=10)
...
def naive_bayes_multinomial(x_train, y_train, x_test, y_test):
    ...
    return cross_val_score(gnb, X_train_minmax, y_train, cv=10)
